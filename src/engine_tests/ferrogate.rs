//! Tests for the ferrogate auth backend, which lives in `crates/bv-auth-ferrogate`.
//!
...
mod test {
    ...
    fn test_real_cmis_jwks_parses() {
        ...
        let raw = include_str!("../../crates/bv-auth-ferrogate/src/testdata/cmis_dev_jwks.json");
    ...
    async fn test_cmis_grpc_live_fetch() {
        ...
        let cfg = crate::modules::credential::ferrogate::FerroGateConfig {
            jwks_source: crate::modules::credential::ferrogate::jwks_source::CMIS_GRPC.to_string(),
