...
//!
//! The actix middleware that consults the guard on every request stays in the
//! root crate (`bastion_vault::dos::middleware`): actix must not reach a leaf
//! engine, and this crate is under every one of them.
//!
