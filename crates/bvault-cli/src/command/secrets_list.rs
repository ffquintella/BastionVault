...
use crate::{
    api::sys::MountOutput,
    command::{self, format::table_data_add_header, CommandExecutor},
    errors::RvError,
};
...
#[command(
    author,
    version,
    about = r#"Lists the enabled secret engines on the BastionVault server. This command also outputs
